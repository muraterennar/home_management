        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(Icons.settings_outlined, Icons.settings, l10n.settings, 3, themeProvider),
            ],
          ),
        ),
      ),
...
class DashboardHome extends StatelessWidget {
  ...
  Widget _buildHeader(BuildContext context, AppLocalizations l10n, ThemeProvider themeProvider) {
  ...
  Widget _buildBudgetOverview(AppLocalizations l10n, ThemeProvider themeProvider) {
    return FadeInUp(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: themeProvider.successColor.withOpacity(0.2)),
              ),
              child: Row(
                children: [
                  Container(
  ...
  Widget _buildBudgetItem(String title, String amount, IconData icon, Color color, String change, ThemeProvider themeProvider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildMonthlyProgress(AppLocalizations l10n, ThemeProvider themeProvider) {
    return FadeInUp(
  ...
  Widget _buildProgressItem(String label, String value, ThemeProvider themeProvider) {
    return Column(
      children: [
        Text(
          value,
            ...
            children: [
              ...
              Expanded(
                child: _buildActionCard(
                  ...
                  () => Navigator.push(context, MaterialPageRoute(builder: (context) => ExpenseDashboardScreen())),
                  themeProvider,
                ),
              ),
              const SizedBox(width: 12),
  ...
  Widget _buildActionCard(String title, IconData icon, Color color, VoidCallback onTap, ThemeProvider themeProvider) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        padding: const EdgeInsets.all(16),
  ...
  Widget _buildRecentTransactions(AppLocalizations l10n, ThemeProvider themeProvider) {
    final transactions = [
      {'title': 'Grocery Shopping', 'amount': '-\$89.30', 'category': 'Shopping', 'time': '2 hours ago', 'icon': Icons.shopping_bag, 'color': themeProvider.warningColor},
      {'title': 'Monthly Salary', 'amount': '+\$2,700', 'category': 'Income', 'time': '1 day ago', 'icon': Icons.account_balance_wallet, 'color': themeProvider.successColor},
      {'title': 'Restaurant Dinner', 'amount': '-\$45.50', 'category': 'Food', 'time': '2 days ago', 'icon': Icons.restaurant, 'color': themeProvider.errorColor},
    ];
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            ...transactions.map((transaction) => _buildTransactionItem(transaction, themeProvider)).toList(),
          ],
        ),
      ),
    );
  ...
  Widget _buildTransactionItem(Map<String, dynamic> transaction, ThemeProvider themeProvider) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              color: (transaction['amount'] as String).startsWith('+') ? themeProvider.successColor : themeProvider.errorColor,
              fontSize: 16,
              fontWeight: FontWeight.bold,
            ),
          ),
